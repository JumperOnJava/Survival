    ...
    public class MapController
    {
        ...
        public void InitializeMap()
        {
            ...
            for (int j = 0; j < mapHeight; j++)
            {
                ...
                {
                    Tile tile = ForestSpriteSheet.GROUND;

                    if (i == 0) tile = ForestSpriteSheet.SIDE_LEFT;
                    if (j == 0) tile = ForestSpriteSheet.SIDE_TOP;
                    if (i == mapWidth - 1) tile = ForestSpriteSheet.SIDE_RIGHT;
                    if (j == mapHeight - 1) tile = ForestSpriteSheet.SIDE_BOTTOM;

                    if (i == 0 && j == 0) tile = ForestSpriteSheet.SIDE_TOP_LEFT;
                    if (i == mapWidth - 1 && j == 0) tile = ForestSpriteSheet.SIDE_TOP_RIGHT;
                    if (i == 0 && j == mapHeight - 1) tile = ForestSpriteSheet.SIDE_BOTTOM_LEFT;
                    if (i == mapWidth - 1 && j == mapHeight - 1) tile = ForestSpriteSheet.SIDE_BOTTOM_RIGHT;
